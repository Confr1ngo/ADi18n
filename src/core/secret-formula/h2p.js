...
<br>
<br>
Their first unlock costs ${format(TimeSpan.fromMilliseconds(NAMELESS_UNLOCKS.FREE_TICKSPEED_SOFTCAP.price).totalYears)}
...
<br>
<br>
At ${format(TimeSpan.fromMilliseconds(NAMELESS_UNLOCKS.RUN.price).totalYears)} years of stored game time, you are able
to finally unlock their Reality. The reward for completing The Nameless Ones' Reality is
${Nameless.isCompleted
...
`,
      isUnlocked: () => Nameless.isCompleted,
...
${Ra.unlocks.namelessUnlock.canBeApplied
